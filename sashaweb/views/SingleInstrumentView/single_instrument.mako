...
<%block name="searchbar">
    <form id="searchbar" class="grid_2" action="${search_action}" method="get">
        ...
        <div class="grid_2 category alpha">
            <div class="label">WITH KEYS:</div>
            <div id="with_keys" class="items">
                <input type="text" name="with_keys" placeholder="i.e. 8va X Bis" value="${with_keys}"/>
            </div>
        </div>
        <div class="grid_2 category alpha">
            <div class="label">W/O KEYS:</div>
            <div id="without_keys" class="items">
                <input type="text" name="without_keys" placeholder="i.e. L1 R1 C3" value="${without_keys}"/>
            </div>
        </div>
        <div class="grid_2 category alpha">
